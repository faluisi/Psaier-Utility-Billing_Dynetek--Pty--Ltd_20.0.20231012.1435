page 70100 "Reactivation Process"
{
    //KB24112023 - TASK002167 Reactivation Process +++
    Caption = 'Reactivation Process';
            ...
            group(Step3)
            {
                ...
                group("Para3.1")
                {
                    ...
                    group("Para3.1.1")
                    {
                        ...
                        field(data_ricenzione; data_ricenzione)
                        {
                            ApplicationArea = all;
                            Caption = 'data ricenzione';
                            ToolTip = 'Specifies the value of the data_ricenzione field';
                        }
                    //KB20112023 - TASK002131 New Activation Process ---
                    }
                }
                ...
                begin
                    ...
                    if Contract.FindFirst()then begin
                        ...
                        if PhysicalContrct.GetConfirm()then begin
                            ActivationDataMgmt.ChangeOfReActivationData(Contract, Notes, data_ricenzione);
                            CurrPage.Close();
                        end;
                    //KB111223 - TASK002199 Physical Contract Report Update ---
